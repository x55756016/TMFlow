    ...
    public class DefaultMessageBLL
    {
        ...
        public void EditDefaultMessage(T_WF_DEFAULTMESSAGE entity)
        {
            try
            {
                ...
                { 
                    ...
                    new Parameter(":MESSAGECONTENT",dal.GetValue(entity.MESSAGECONTENT)), 
                    new Parameter(":APPLICATIONURL",dal.GetValue(entity.APPLICATIONURL)),    
                    new Parameter(":UPDATEUSERID",dal.GetValue(entity.CREATEUSERID)),
                    new Parameter(":UPDATEUSERNAME",dal.GetValue(entity.CREATEUSERNAME)),
                    new Parameter(":UPDATEDATE",dal.GetValue(DateTime.Now)),
                    new Parameter(":MESSAGEID",dal.GetValue(entity.MESSAGEID))
        ...
        public void DeleteDefaultMessage(string DeleteID)
        {
            try
            {
                ...
                Parameter[] pageparm =
                { 
                    new Parameter(":MESSAGEID",dal.GetValue(DeleteID)), 
                };
