...
namespace SMT.Workflow.Engine.Services
{
    ...
    public class EngineWcfGlobalFunction : IEngineWcfGlobalFunction
    {
        ...
        {
            Tracer.Debug("SaveFlowTriggerData():strFlowMessage:" + strFlowMessage + "strBOObject:" + strBOObject + "");
        ...
        {
            Tracer.Debug("FlowCancel():strFlowXML:" + strFlowXML + "strAppXml:" + strAppXml + "");
            EngineServicesBLL bll = new EngineServicesBLL();
        ...
        public bool FlowConsultati(List<CustomUserMsg> UserAndForm, string strTitle, string strFlowXML, string strAppXml)
        {
            ...
            Tracer.Debug("FlowConsultati():UserAndForm:" + ss + "strTitle:" + strTitle + "strFlowXML:" + strFlowXML + "strAppXml:" + strAppXml + "");
            return true;
        }

        public void FlowConsultatiClose(string strSystemCode, string strFormID, string strReceiveUser)
        {
            Tracer.Debug("FlowConsultatiClose():strSystemCode:" + strSystemCode + "strFormID:" + strFormID + "strReceiveUser:" + strReceiveUser + "");
        }
        ...
        public List<T_FLOW_ENGINEMSGLIST> PendingTasksParmsPageIndex(MsgParms msgParams, ref int rowCount, ref int pageCount)
        {
            ...
            Tracer.Debug("PendingTasksParmsPageIndex()msgParams:" + ss + "||rowCount:" + rowCount + "||pageCount:" + pageCount + "");
            EngineServicesBLL bll = new EngineServicesBLL();
        ...
        public Dictionary<string, T_FLOW_ENGINEMSGLIST> GetPendingTaskPrevNext(MsgParms msgParams)
        {
            ...
            ss += "PageSize:" + msgParams.PageSize + "Status:" + msgParams.Status + "Top:" + msgParams.Top;
            ss += "UserID:" + msgParams.UserID + "";
            Tracer.Debug("GetPendingTaskPrevNext()msgParams:" + ss + "");
            EngineServicesBLL bll = new EngineServicesBLL();
        ...
        {
            Tracer.Debug("PendingDetailTasksByOrderNodeCodeForMobile()orderNodeCode:" + orderNodeCode + "");
            EngineServicesBLL bll = new EngineServicesBLL();
        ...
        {
            Tracer.Debug("EngineNotes()strUserID:" + strUserID + "strStatus:" + strStatus + "iTop:" + iTop + "");
            EngineServicesBLL bll = new EngineServicesBLL();
        ...
        {
            Tracer.Debug("CancelEventTriggerData()strApplicationOrderCode:" + strApplicationOrderCode + "");
            EngineServicesBLL bll = new EngineServicesBLL();
        ...
        public void MsgTrigger(string[] recevieUser, string SystemCode, string MsgKey, string ID, string strXml)
        {
            ...
            Tracer.Debug("MsgTrigger()SystemCode:" + SystemCode + "MsgKey:" + MsgKey + "ID" + ID + "strXml" + strXml + "recevieUser" + recevieUser + "");
            EngineServicesBLL bll = new EngineServicesBLL();
        ...
        public void NotesSend(List<ReceiveUserAndContent> List, string SystemCode, string strFormID)
        {
            ...
            Tracer.Debug("NotesSend()SystemCode:" + SystemCode + "List:" + ss + "strFormID" + strFormID + "");
            EngineServicesBLL bll = new EngineServicesBLL();
        ...
        {
            Tracer.Debug("TaskMsgClose()strSystemCode:" + strSystemCode + "strFormID:" + strFormID + "strReceiveUser:" + strReceiveUser + "");
            EngineServicesBLL bll = new EngineServicesBLL();
        ...
        public void MsgListClose(string strSystemCode, List<ReceiveUserForm> List)
        {
            ...
            Tracer.Debug("MsgListClose()strSystemCode:" + strSystemCode + "List:" + ss + "");
            EngineServicesBLL bll = new EngineServicesBLL();
        ...
        {
            Tracer.Debug("ModelMsgClose()strModelCode:" + strModelCode + "strReceiveUser:" + strReceiveUser + "");
            EngineServicesBLL bll = new EngineServicesBLL();
        ...
        {
            Tracer.Debug("ClosedDoTaskFromID()strModelCode:" + strModelCode + "fromID:" + fromID + "");
            EngineServicesBLL bll = new EngineServicesBLL();
        ...
        {
            Tracer.Debug("MsgClose()strMessageID:" + strMessageID + "strEventID:" + strEventID + "");
            EngineServicesBLL bll = new EngineServicesBLL();
        ...
        public void ApplicationMsgTrigger(List<CustomUserMsg> UserAndForm, string SystemCode, string ModelCode, string strXml, MsgType msgType)
        {
            ...
            Tracer.Debug("ApplicationMsgTrigger()UserAndForm:" + ss + "SystemCode:" + SystemCode + "ModelCode:" + ModelCode + "strXml:" + strXml + "msgType:" + msgType.ToString() + "");
            EngineServicesBLL bll = new EngineServicesBLL();
        ...
        {
            Tracer.Debug("AppMsgTrigger()ReceiveUserID:" + ReceiveUserID + "strFormID:" + strFormID + "MsgContent:" + MsgContent + "strXml:" + strXml + "strNewGuid:" + strNewGuid + "");
            EngineServicesBLL bll = new EngineServicesBLL();
        ...
        public void ApplicationNotesTrigger(List<CustomUserMsg> UserAndForm, string SystemCode, string Content)
        {
            ...
            Tracer.Debug("ApplicationNotesTrigger()UserAndForm:" + ss + "SystemCode:" + SystemCode + "Content:" + Content + "");
            EngineServicesBLL bll = new EngineServicesBLL();
        ...
        public List<T_FLOW_CUSTOMFLOWDEFINE> CustomFlowDefineList(int pageIndex, int pageSize, string sort, string filterString, IList<object> paras, ref int pageCount, string strCompanyID)
        {
            ...
            Tracer.Debug("CustomFlowDefineList()pageIndex:" + pageIndex + "pageSize:" + pageSize + "sort:" + sort + "filterString:" + filterString + "strCompanyID:" + strCompanyID + "paras:" + ww + "");
            EngineServicesBLL bll = new EngineServicesBLL();
        ...
        public void SendMail(List<MailParams> mailParams)
        {
            ...
            Tracer.Debug("SendMail()mailParams:" + ss + "");
            EngineServicesBLL bll = new EngineServicesBLL();
        ...
        public bool SendMailParam(List<MailParams> mailParams, string mailType, string mailParameter)
        {
            ...
            {
                Tracer.Debug("SendMailParam()Exception:" + ex.Message + "");
                return false;
            }
        }
        ...
        public void TaskDelete(List<CustomUserMsg> UserAndForm, string strSystemCode)
        {
            ...
            Tracer.Debug("TaskDelete()UserAndForm:" + ss + "strSystemCode:" + strSystemCode + "");
            EngineServicesBLL bll = new EngineServicesBLL();
        ...
        public string SendTaskMessage(List<CustomUserMsg> list, string SystemCode, string ModelCode)
        {
            try
            {
                Tracer.Debug("开始调用SendTaskMessage()ModelCode:" + ModelCode + "");
                EngineServicesBLL bll = new EngineServicesBLL();
            ...
            {
                Tracer.Debug("新增方法SendTaskMessage():" + ex.Message + "");
                return ex.Message;
            }
        }
        ...
        public string WFAddTimingTrigger(T_WF_TIMINGTRIGGERACTIVITY entity)
        {
            try
            {
                Tracer.Debug("WFAddTimingTrigger()开始调用");
                EngineServicesBLL bll = new EngineServicesBLL();
            ...
            {
                Tracer.Debug("WFAddTimingTrigger()" + ex.Message);
                return ex.Message;
            }
        }
        ...
        {
            Tracer.Debug("SaveEventData()strEventXml:" + strEventXml + "");
            EngineServicesBLL bll = new EngineServicesBLL();
        ...
        public T_WF_DOTASK GetDoTaskEntity(string orderID, string receiveUserID)
        {
            ...
            {
                Tracer.Debug("GetDoTaskEntity()orderID:" + orderID + "receiveUserID:" + receiveUserID + "||Message:" + ex.Message + "||StackTrace:" + ex.StackTrace);
                return null;
            }
        }
        ...
        {
            Tracer.Debug("ReturnUserInfoDask()modelCode||" + modelCode);
            EngineServicesBLL bll = new EngineServicesBLL();
