...
namespace SMT.Workflow.Common.DataAccess
{
      ...
      //  }
        ...
        public static DataTable GetDataTable(string sqlString)
        {
            using (OracleConnection conn = new OracleConnection(ConnectionString))
            {
                ...
                {
                    conn.Close();
                    Tracer.Debug("MsOracle.GetDataTable", sqlString, e);
        ...
        public static DataSet GetDataSetByConnection(string connectionString, string sqlString)
        {
            using (OracleConnection conn = new OracleConnection(connectionString))
            {
                ...
                {
                    conn.Close();
                    Tracer.Debug("MsOracle.GetDataSetByConnection", sqlString, e);
                    throw new System.Exception(e.Message);
                }
                finally
                {
        ...
        public static OracleDataReader GetOracleDataReader(string sqlString)
        {
            ...
            {
                connection.Close();
                Tracer.Debug("MsOracle.GetOracleDataReader", sqlString, e);
                throw new System.Exception(e.Message);
            }
        }
        /// <summary>
        ...
        public static string GetOneValue(string sqlString, params OracleParameter[] cmdParms)
        {
            using (OracleConnection connection = new OracleConnection(ConnectionString))
            {
                ...
                {
                    connection.Close();
                    Tracer.Debug("MsOracle.GetOneValue", sqlString, e);
                    throw new System.Exception(e.Message);
                }
                finally
                {
        ...
        public static void ExecuteSQLTransaction(List<string> SQLStringList)
        {
            using (OracleConnection connection = new OracleConnection(ConnectionString))
            {
                ...
                catch (OracleException e)
                {
                    ...
                    Tracer.Debug("MsOracle.ExecuteSQLTransaction", stringlist, e);
                    throw new System.Exception(e.Message);
                }
                finally
                {
        ...
        private static void AssignParameterValues(OracleParameter[] commandParameters, object[] parameterValues)
        {
            ...
            {
                Tracer.Debug("MsOracle.AssignParameterValues", "参数不匹配参数值的个数", null);
        ...
        public static void CommitTransaction()
        {
            ...
            catch (OracleException e)
            {
                ...
                Close();
                Transaction = null;
                Tracer.Debug("MsOracle.CommitTransaction",null, e);
                throw new System.Exception(e.Message);
            }
            finally
            {
        ...
        public static void CommitTransaction(OracleConnection connObjection)
        {
            ...
            catch (OracleException e)
            {
                ...
                Close(connObjection);
                Transaction = null;
                Tracer.Debug("MsOracle.CommitTransaction(OracleConnection connObjection)", null, e);
                throw new System.Exception(e.Message);
            }
            finally
            {
        ...
        public static void RollbackTransaction(OracleConnection connObjection)
        {
            ...
            catch (OracleException e)
            {
                ...
                Close(connObjection);
                Transaction = null;
                Tracer.Debug("MsOracle.RollbackTransaction(OracleConnection connObjection)", null, e);
                throw new System.Exception(e.Message);
            }           
        }
        ...
        public static int ExecuteSQLByTransaction(OracleConnection connObjection, string sqlString, params OracleParameter[] parameterValues)
        {
            ...
            catch (System.Exception e)
            {
                if (cmd.Transaction != null)
                {
                    ...
                    Tracer.Debug("MsOracle.ExecuteSQLByTransaction(OracleConnection connObjection, string sqlString, params OracleParameter[] parameterValues)", "回滚事务", e);
                }
                throw new System.Exception(e.Message);
            }
        }
        ...
        public static int ExecuteSQLByTransaction(string sqlString, params OracleParameter[] parameterValues)
        {
            ...
            catch (System.Exception e)
            {
                ...
                {
                    cmd.Transaction.Rollback();
                    Tracer.Debug("MsOracle.ExecuteSQLByTransaction(string sqlString, params OracleParameter[] parameterValues)", "回滚事务", e);
                }
                throw new System.Exception(e.Message);
            }
        }
        ...
        public static int ExecuteSQLByTransaction(OracleConnection connObjection, string sqlString)
        {
            ...
            catch (System.Exception e)
            {
                ...
                {
                    cmd.Transaction.Rollback();
                    Tracer.Debug("MsOracle.ExecuteSQLByTransaction(OracleConnection connObjection, string sqlString)", "回滚事务", e);
                }
                throw new System.Exception(e.Message);
            }
        }
        ...
        public static int ExecuteSQLByTransaction(string sqlString)
        {
            ...
            catch (System.Exception e)
            {
                ...
                {
                    cmd.Transaction.Rollback();
                    Tracer.Debug("MsOracle.ExecuteSQLByTransaction(string sqlString)", "回滚事务", e);
                }
                throw new System.Exception(e.Message);
            }
        }
        ...
        public static object ExecuteScalarByTransaction(OracleConnection connObjection, string sqlString, OracleParameter[] parameterValues)
        {
            ...
            catch (System.Exception e)
            {
                ...
                {
                    cmd.Transaction.Rollback();
                    Tracer.Debug("MsOracle.ExecuteScalarByTransaction(OracleConnection connObjection, string sqlString, params OracleParameter[] parameterValues)", "回滚事务", e);
                }
                throw new System.Exception(e.Message);
            }
        }
        ...
        public static OracleDataReader ExecuteReaderByTransaction(OracleConnection connection, string sqlString, OracleParameter[] parameterValues)
        {
            ...
            catch (System.Exception e)
            {
                ...
                {
                    cmd.Transaction.Rollback();
                    Tracer.Debug("MsOracle.ExecuteReaderByTransaction(OracleConnection connection, string sqlString, OracleParameter[] parameterValues)", "回滚事务", e);
                }
                throw new System.Exception(e.Message);
            }            
        }
        ...
        public static DataTable GetDataTableByTransaction(OracleConnection connObjection, string sqlString, params OracleParameter[] parameterValues)
        {
            ...
            catch (System.Exception e)
            {
                ...
                {
                    cmd.Transaction.Rollback();
                    Tracer.Debug("MsOracle.GetDataTableByTransaction(OracleConnection connObjection, string sqlString, params OracleParameter[] parameterValues)", "回滚事务", e);
                }
                throw new System.Exception(e.Message);
            }
        }
        ...
        public static DataSet GetDataSetByTransaction(OracleConnection connObjection, string sqlString, params OracleParameter[] parameterValues)
        {
            ...
            catch (System.Exception e)
            {
                ...
                {
                    cmd.Transaction.Rollback();
                    Tracer.Debug("MsOracle.GetDataSetByTransaction(OracleConnection connObjection, string sqlString, params OracleParameter[] parameterValues)", "回滚事务", e);
                }
                throw new System.Exception(e.Message);
            }
        }
    ...
    public sealed class MicrosoftOracle
    {
        ...
        public static OracleConnection CreateOracleConnection(string connectionString)
        {
            ...
            {
                Tracer.Debug("CreateOracleConnection出错:" + ex.ToString());
                return null;
            }
            return conn;
        }
        ...
        public static void Open(OracleConnection connection)
        {
            if (connection != null)
            {
                ...
                catch (System.Exception ex)
                {
                    connection.Close();
                    connection.Dispose();
                    Tracer.Debug("打开数据库出错:" + ex.ToString());
                }
            }
        }
        #endregion
        ...
        public  void BeginTransaction(OracleConnection connObjection)
        {
            if (Transaction == null || Transaction.Connection != connObjection)
            {
                ...
                {
                    Tracer.Debug("数据库连接已关闭!"+connObjection.ConnectionString);
                    connObjection.Open();
                    Tracer.Debug("数据库连接重新打开!" + connObjection.ConnectionString);
                    Transaction = connObjection.BeginTransaction(IsolationLevel.ReadCommitted);
                }
            }
        }
        ...
        public static int ExecuteNonQuery(OracleConnection connection, CommandType commandType, string commandText, params OracleParameter[] commandParameters)
        {
            ...
            catch (System.Exception ex)
            {
                connection.Close();
                connection.Dispose();
                Tracer.Debug("ExecuteNonQuery出错:" + ex.ToString());
                return 0;
            }
        }
        #endregion
        ...
        public static int ExecuteSQL(OracleConnection conn, string sqlString, params OracleParameter[] parameterValues)
        {
            ...
            catch (System.Exception ex)
            {
                conn.Close();
                conn.Dispose();
                Tracer.Debug("ExecuteSQL数据库出错:" + ex.ToString());
                return 0;
            }
        }
        #endregion
        ...
        public static DataSet ExecuteDataset(OracleConnection connection, CommandType commandType, string commandText, params OracleParameter[] commandParameters)
        {
            ...
            catch (System.Exception ex)
            {
                connection.Close();
                connection.Dispose();
                Tracer.Debug("ExecuteDataset出错:" + ex.ToString());
                return null;
            }
        }
