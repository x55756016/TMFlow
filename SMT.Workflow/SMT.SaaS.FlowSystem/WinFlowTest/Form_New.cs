...
{
    public partial class Form_New :  BaseDAL
    {
        public Form_New()
        {
            InitializeComponent();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            IDataReader dr2 = dao.ExecuteReader(sql2);
            if (dr.Read())
            {
        ...
        private void button4_Click_1(object sender, EventArgs e)
        {
            try
            {
                if (chkDetail.Checked)
                {
                    ...
                    dt = dao.GetDataTable(sb.ToString());
                ...
                else
                {
                    ...
                    //cmd.CommandText = sb.ToString();
                    //cmd.CommandType = CommandType.Text;
                    IDataReader dr = dao.ExecuteReader(sb.ToString());
                    if (dr.Read())
                    {
                    ...
                    //cmd.CommandText = sql;
                    //cmd.CommandType = CommandType.Text;
                    IDataReader dr2 = dao.ExecuteReader(sql);
                    if (dr2.Read())
                    {
